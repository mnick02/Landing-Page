This project aims to test skills in html, css and flexbox. At the end of this project I will have demonstrated proficency in all those skills by creating a well put together mock landing page. 
